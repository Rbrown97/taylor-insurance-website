...
export default function UserPolicies() {
    ...
    const customerQuotes = customers[userID-1].homes[0].homePolicy
        ...
        <Box sx={{
            ...
            <Paper elevation={10}  sx={{
                ...
                <Typography variant="h4">
                    Here are your Home Policies, {customers2[userID-1].firstName}
                </Typography>
                <Stack direction="row" spacing={50} justifyContent="center" sx={{pt: 5}}>
                <Paper elevation={10} sx={{
                    justifyContent: 'center',
                    backgroundColor: '#E6EFEB',
                    pb: 5,
                ...
                Home Policy 1
                    ...
                    <Typography variant="subtitle1">
                        home Policy Premium: ${customerQuotes.homePolicyPremium}<br/>
                        home Policy Start Date: {customerQuotes.homePolicyStartDate}<br/>
                        home Policy End Date: {customerQuotes.homePolicyEndDate}
                    </Typography>
                    </Paper>
                </Stack>
